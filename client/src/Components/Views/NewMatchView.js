...
function NewMatchView() {
    ...
    return (
      <body>
        <h1 className="h1-view"> Partido Creado Correctamente <span><Link to="/HomeUser/MainHomeUser"><input class="boton-view btn btn-primary" type="reset" value="Home"/></Link></span></h1>
